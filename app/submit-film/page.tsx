            ...
            <div className="font-texta text-[#091529] pb-0 mb-0 text-left">
              ...
              <section className="mb-0">
                ...
                <ul className="font-texta text-sm sm:text-base md:text-lg leading-tight space-y-2 sm:space-y-2.5 list-disc pl-6 sm:pl-8 text-left">
                  ...
                  <li>
                  <strong>Screenings:</strong> Selected films will be shown at <strong>Minto Hall</strong> before a live audience. A screening schedule will be shared in advance. Filmmakers are encouraged (but not required) to attend for networking opportunities.
                  </li>
                  <li>
